...
extern int leftfront,rightfront,leftrear,rightrear;
...
void run_cross() {
    bool Xfound = Lpt0_found && Lpt1_found;
    int64_t current_encoder = (leftfront+rightfront+leftrear+rightrear)*0.25;
