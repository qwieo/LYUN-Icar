...
// Left and right information After Sample
...
// After the middle line tracking process
AT_DTCM_SECTION_ALIGN(float rptss0[POINTS_MAX_LEN][2], 8);
AT_DTCM_SECTION_ALIGN(float rptss1[POINTS_MAX_LEN][2], 8);
//Counter of 
int rptss0_num, rptss1_num;
//
//Long straight
